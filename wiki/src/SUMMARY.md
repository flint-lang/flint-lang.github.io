...
- [From Beginner to Intermediate](./beginners_guide.md)
  ...
  - [Objects](./beginners_guide/8_objects.md)
    - [Simple Object](./beginners_guide/8_objects/1_simple_object.md)
    - [Func Component](./beginners_guide/8_objects/2_func_component.md)
    - [Composition](./beginners_guide/8_objects/3_composition.md)
    - [Signatures](./beginners_guide/8_objects/4_signatures.md)
    - [Func Instance](./beginners_guide/8_objects/5_func_instance.md)
    - [Interfaces](./beginners_guide/8_objects/6_interfaces.md)

  - [Interop](./beginners_guide/9_interop.md)
    - [Introduction](./beginners_guide/9_interop/1_introduction.md)
    - [Defining External Functions](./beginners_guide/9_interop/2_defining.md)
    - [Interop Modules](./beginners_guide/9_interop/3_modules.md)
    - [Signatures](./beginners_guide/9_interop/4_signatures.md)
    - [Pointer Types](./beginners_guide/9_interop/5_pointers.md)
  ...
  - [Game Example](./beginners_guide/10_game_example.md)
    ...
    - [The Ball](./beginners_guide/10_game_example/2_the_ball.md)
    - [Paddles](./beginners_guide/10_game_example/3_paddles.md)
    - [Collision Detection](./beginners_guide/10_game_example/4_collisions.md)
    - [Player and CPU](./beginners_guide/10_game_example/5_player_and_cpu.md)
    - [Scoring System](./beginners_guide/10_game_example/6_scoring_system.md)
    - [Sound Effects](./beginners_guide/10_game_example/7_sound_effects.md)
    - [Finishing Touches](./beginners_guide/10_game_example/8_finishing_touches.md)
...
- [Core Modules](./core_modules.md)
  - [assert](./core_modules/1_assert.md)
  - [array](./core_modules/2_array.md)
  - [env](./core_modules/3_env.md)
  - [filesystem](./core_modules/4_filesystem.md)
  - [math](./core_modules/5_math.md)
  - [meta]()
  - [parallel]()
  - [parse](./core_modules/8_parse.md)
  - [print](./core_modules/9_print.md)
  - [random]()
  - [read](./core_modules/11_read.md)
  - [system](./core_modules/12_system.md)
