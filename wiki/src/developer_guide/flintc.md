...
GitHub page: [https://github.com/flint-lang/flintc](https://github.com/flint-lang/flintc)
...
The `flintc` project is the main project for Flint, and it also contains the `fls` project as a subproject, but the documentation for the language server is done in a [separate](./fls.md) chapter.
