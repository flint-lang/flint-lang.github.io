...
Since FIP currently is broken in Windows (for more information look [here](../../user_guide/setup/4_fip_setup.md) this game example would be pretty hard to implement on Windows.
