...
Flint brings along a completely new paradigm called **Declarative Composable Modules Paradigm (DCMP)**. What this paradigm means and what it brings to the table will be discussed thoroughly in later chapters, but `data` is very important for it. Unlike other paradigms like OOP (Object-Oriented Programming) you cannot attach functions to data. In Flint, data is exactly just that: data. Nothing more, nothing less.
