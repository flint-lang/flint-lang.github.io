hljs.registerLanguage(
  ...
  (function () {
    ...
    return function (e) {
      ...
      var keywords = {
        $pattern: e.IDENT_RE + "!?",
        keyword: "use as extern def data func entity enum error variant requires extends link hook return throw catch if else do while for in continue break switch spawn sync async type",
